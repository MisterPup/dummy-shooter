...
void Utility::drawAxis(float length_x, float length_y, float length_z)
{
	glBegin(GL_LINES);
...
//0 = ok
int Utility::screenToWorldCoordinates(GLfloat* screenCoordinates, int numScreenCoordinates, GLdouble worldCoordinates[3])
{
...
void Utility::getStringLenghtInWorldCoordinates(char *string, void* font, float x, float y, float length[2])
{
	glRasterPos2f(x, y);
